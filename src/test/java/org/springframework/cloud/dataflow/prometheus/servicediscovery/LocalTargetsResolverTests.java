...
public class LocalTargetsResolverTests {
	...
	public void testEmptyResponse() throws IOException, URISyntaxException {
		...
		mockServer.expect(ExpectedCount.once(),
				...
				.andRespond(withStatus(HttpStatus.OK)
						...
						.body(asString("classpath:/runtime_apps_empty.json"))
				);
		...
		assertThat(scs[0].getTargets().size(), is(0));
	}
	...
	public void testMissingServer() throws URISyntaxException {
		...
		assertThat(targets, Matchers.notNullValue());
		assertThat(targets, is(""));
	}

	@Test
	public void testNotEmptyResponse() throws IOException, URISyntaxException {
		...
		assertThat(scs.length, is(1));
		assertThat(scs[0].getLabels().get("job"), is("scdf"));
		assertThat(scs[0].getTargets(), contains("172.18.0.4:20080", "172.18.0.4:20032"));
	}
